<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
    <ul class="navbar-nav ms-md-auto pe-md-3 d-flex align-items-center">
        ...
        <li class="nav-item d-flex pe-4 align-items-center">
            <a href="/admin/dashboard" class="nav-link text-white font-weight-bold px-0">
                <i class="fa fa-screwdriver-wrench me-sm-1"></i>
                <span class="d-sm-inline d-none">Administration</span>
            </a>
        </li>
